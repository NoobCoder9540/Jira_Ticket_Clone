...
modalCont.addEventListener("keydown", function (e) {
  ...
  if (key == "Shift") {
    ...
    modalCont.style.display = "none"; //modal display to remove after ticket
    addFlag = false;
    taskAreaCont.value = "";
  }
});
...
function createTicket(ticketColor, ticketTask, ticketID) {
  ...
  let ticketCont = document.createElement("div");  //create a div
  ...
  mainCont.appendChild(ticketCont);  // Add to main cont in HTML
